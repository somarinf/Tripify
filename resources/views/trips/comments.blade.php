                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 text-primary">
                            <i class="bx bx-comment me-2"></i>Comentarios del Viaje: {{ $trip->name }}
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4">
            <div class="col-xxl">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('trips.comments.store', $trip->id) }}" method="post">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" rows="3" 
                                              placeholder="Escribe tu comentario sobre este viaje..." required>{{ old('content') }}</textarea>
                                    @error('content')
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mb-0">Sé el primero en comentar sobre este viaje</p>
                    </div>
                @endif
            </div>
        </div>
