        ...
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('trips.update', $trip->id) }}" method="post" class="formulario-validacion">
                            @method('put')
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="name">Nombre</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $trip->name }}" placeholder="Nombre del viaje">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="total">Total</label>
                                <div class="col-sm-10">
                                    <input type="number" name="total" id="total" class="form-control" value="{{ $trip->total }}" placeholder="Costo total">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" id="description" class="form-control" placeholder="Breve descripción del viaje">{{ $trip->description }}</textarea>
                                </div>
                            </div>
