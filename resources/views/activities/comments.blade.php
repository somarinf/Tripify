        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <a href="{{ route('activities.index', $activity->stage_id) }}" class="btn btn-outline-primary">
                            <i class="bx bx-arrow-back me-1"></i> Regresar a Actividades
                        </a>
                    </div>
                    <div>
                        <h4 class="mb-0 text-primary">
                            <i class="bx bx-comment me-2"></i>Comentarios de la Actividad: {{ $activity->name }}
                        </h4>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" rows="3" 
                                              placeholder="Escribe tu comentario sobre esta actividad..." required>{{ old('content') }}</textarea>
                                    @error('content')
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mb-0">Sé el primero en comentar sobre esta actividad</p>
                    </div>
                @endif
            </div>
        </div>
